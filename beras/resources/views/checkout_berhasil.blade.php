...
<!-- 				<form action="{{route('cek_status.show',$info->trans_id)}}" method="post" enctype="multipart/form-data">
					{{csrf_field()}}
			...
			// date_default_timezone_set('Asia/Jakarta');
				...
				<div class="checkout-right-basket">
					<a href="{{route('cek_status.show',$info->trans_id)}}" ><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>Upload Bukti</a>
				</div>
		...
		<div class="col-md-12" style="border-top: solid;border-left:  solid;border-right:  solid; text-align: center;padding: 2%;">
			...
			<h4 style="padding: 2%;">Trans Kode anda Adalah : {{$info->trans_kode}}</h4>
		...
		<div class="col-md-12" style="border-style: solid;; text-align: center;padding: 2%;">
			...
			<h5 style="padding: 2%; color: red">{{'Rp. '.strrev(implode('.',str_split(strrev(strval($info->trans_total)),3))).""}}</h5>
		...
		<div class="col-md-12" style="border-bottom: solid;border-left:  solid;border-right:  solid;border-left: solid; text-align: center;padding: 2%;">
			<img src="/uploads/bank/{{$info->bank_foto}}" width="10%">
			<h4 style="padding: 2%;">A/N : {{$info->bank_an}}</h4>
			<h4 style="padding: 2%;">No Rekening : {{$info->bank_norek}}</h4>
		</div>
	</div>
</div>	
@endforeach
