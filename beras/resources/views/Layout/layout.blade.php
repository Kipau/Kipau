...
<head>
	<title>Mlatiharjo | @yield('title')</title>
	<!-- for-mobile-apps -->
					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
							<ul class="nav navbar-nav">
								<li class="active"><a href="{{route('shop.index')}}" class="act">Home</a></li>	
								<!-- Mega Menu -->
								<li class="dropdown">
										...
										<div class="row">
											<div class="multi-gd-img">
												<ul class="multi-column-dropdown">
													<h6>All Product</h6>
													@foreach($nav as $crud)
													<li><a href="{{route('shop.edit', $crud->produk_id)}}">{{$crud->produk_nama}}</a></li>
													@endforeach
												</ul>
											</div>	
					...
					<div class="w3_footer_grids">
						...
						<div class="col-md-3 w3_footer_grid">
							...
							<ul class="info"> 
								...
								<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="{{URL::to('beras')}}">Beras Hitam</a></li>
								<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="{{URL::to('beras')}}">Beras Merah</a></li>
								<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="{{URL::to('beras')}}">Beras Brown</a></li>
						...
						<div class="col-md-3 w3_footer_grid">
							...
							<ul class="info"> 
								...
								<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="{{URL::to('login')}}">Login</a></li>
								<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="{{URL::to('register')}}">Create Account</a></li>
							</ul>
						</div>
						<div class="clearfix"> </div>
					</div>
