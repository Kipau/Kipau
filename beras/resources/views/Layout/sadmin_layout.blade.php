        ...
        <aside class="main-sidebar">
          ...
          <section class="sidebar">
            ...
            <ul class="sidebar-menu">
              ...
              <li @yield('h')>
                <a href="{{URL::to('scourier')}}">
                  <i class="fa fa-ship"></i> <span>Kurir</span>
                </a>
              </li>
              <li @yield('i')>
                <a href="{{URL::to('spayment')}}">
...
//         $.get("{{URL::to('timeoutsession')}}", function(data){
//         if(data==0) window.location.href="{{URL::to('login')}}";
//         });
//     },1*6*10);
// });
