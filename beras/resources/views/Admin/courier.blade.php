						...
						<table id="example1" class="table table-bordered table-striped table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<form method="POST" action="{{ route('courier.destroy', $crud->kurir_id) }}" accept-charset="UTF-8">
											<input name="_method" type="hidden" value="DELETE">
											<input name="_token" type="hidden" value="{{ csrf_token() }}">
											<div class="tools" >
												<a href="{{route('courier.edit', $crud->kurir_id)}}" data-toggle="tooltip" title="Edit" class="btn btn-default" style="color: #dd4b39;"><i class="fa fa-edit"></i></a>
