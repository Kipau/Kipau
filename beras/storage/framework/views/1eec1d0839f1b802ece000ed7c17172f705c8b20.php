		...
		<div class="container">
			...
			<div class="checkout-right">
				<table class="timetable_sub" id="keranjang" name="keranjang">
					...
					<tr class="rem1">
						<td class="invert"><?php echo e($i+1); ?></td>
						<td class="invert-image"><a href="single.html"><img src="/uploads/produk/<?php echo e($crud->produk_foto); ?>"  alt=" "  /></a></td>
						<td class="invert">
							<div class="quantity"> 
								<div class="quantity-select">                           
									<!-- <div class="entry value-minus">&nbsp;</div> -->
									<div class="entry value"><span><?php echo e($qtys[$i]); ?></span></div>
									<!-- <div class="entry value-plus active">&nbsp;</div> -->
								</div>
							</div>
						</td>
						<td class="invert"><p id="merk"><?php echo e($crud->produk_nama); ?> </p></td>

						<td class="invert"><?php echo e($crud->produk_harga*$qtys[$i]); ?></td>
						<td class="invert">
							<div class="rem">
...
<form action="<?php echo e(route('checkout.store')); ?>" method="post" name="form1" enctype="multipart/form-data">
	...
	<div class="container brands">
		...
		<div class="col-sm-6">
			<div class=" form-group">
				...
				<textarea class="form-control" name="note" id="note" rows="7" cols="30" placeholder="note..."></textarea>
			</div>
		</div>
		...
		<div class="col-sm-3">
			<div class=" form-group">
				...
				<select class="form-control" id="bank" name="bank">
					...
					<option value="<?php echo e($bank->bank_id); ?>"><?php echo e($bank->bank_nama); ?></option>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				</select>
			</div>
		</div>
		...
		<div class="col-sm-3 form-group">
			...
			<select onchange="GetOngkir();" class="form-control" id="kurir" name="kurir">
				...
				<option value="<?php echo e($kurir->kurir_id); ?>"><?php echo e($kurir->kurir_nama); ?></option>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			</select>
		</div>
		<div class="col-sm-3 form-group">
...
<div class="container">
	...
	<div class="checkout-left">	
		<div class="checkout-left-basket">
			...
			<ul>
				<li>SubTotal <i>-</i> <span><?php echo e($total); ?></span></li>
		...
		<div class="checkout-right-basket">
			<button onclick="resetcart();" type="submit" style="padding: 3px 28px 3px 20px;
			color: #fff;
			font-size: 1em;
			background: #212121;
		...
		<div class="checkout-right-basket" style="margin-right:1%">
			<a href="<?php echo e(route('shop.index')); ?>" style="padding: 0px 28px 10px 20px;"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>Continue Shopping</a>
		</div>
	</div>
...
<div class="modal fade" id="myModal" role="dialog">
	...
	<div class="modal-content">
		...
		<div class="modal-body">
			<div class="container">
				...
				<div class="col-md-12">
					<div class=" form-group">
						<label>Alamat :</label>
						<textarea class="form-control" name="alamat" id="alamat" rows="4" cols="100" placeholder="note..."><?php echo e($alamat->customer_alamat); ?></textarea>
					</div>
				</div>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		...
		<div class="modal-footer">
			<!-- <a type="submit" class="btn btn-danger" href="<?php echo e(URL::to('checkout_berhasil')); ?>">Kembali</a> -->
