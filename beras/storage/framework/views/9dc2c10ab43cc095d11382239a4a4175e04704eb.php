						...
						<table id="example1" class="table table-bordered table-striped table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<div class="tools" >
											<a href="<?php echo e(route('transaction.show', $crud->trans_kode)); ?>" data-toggle="tooltip" title="Detail Transaction" class="btn btn-default" style="color: #dd4b39;"><i class="fa fa-search-plus"></i></a>
										</div>
									</td>
								</tr>
