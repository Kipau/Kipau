			...
			<div class="col-xs-12">
				...
				<div class="box">
					...
					<div class="box-header">
						...
						<a  class="btn  btn bg-maroon btn-flat margin" href="<?php echo e(route('bank.create')); ?>">
								...
								<tr>
									...
									<td>
										<form method="POST" action="<?php echo e(route('sbank.destroy', $crud->bank_id)); ?>" accept-charset="UTF-8">
											...
											<div class="tools" >
												<a href="<?php echo e(route('sbank.edit', $crud->bank_id)); ?>" data-toggle="tooltip" title="Edit" class="btn btn-default" style="color: #dd4b39;"><i class="fa fa-edit"></i></a>

												<button type="submit" class="btn btn-default" data-toggle="tooltip" title="Delete" style="color: #dd4b39;" onclick="return confirm('Anda yakin akan menghapus data ? <?php echo e($crud->bank_nama); ?>');" >
